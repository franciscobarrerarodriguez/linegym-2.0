<div class="page-container sidebar-collapsed"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
	...
	<div class="sidebar-menu">
		...
		<div class="sidebar-menu-inner">
			...
			function addClassActive(){
				document.getElementById("menu_home").setAttribute("class" , 'active');
			}
			addClassActive();
			</script>
		...
		<div class="row">
				...
				<ul class="user-info pull-left pull-none-xsm">
					...
					<li class="profile-info dropdown"><!-- add class "pull-right" if you want to place this from right -->
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<img src="<?php echo base_url('assets/lineGym/img/profile.jpg')?>" alt="" class="img-circle" width="44" />
			...
			<div class="col-md-6 col-sm-4 clearfix hidden-xs">
				...
				<ul class="list-inline links-list pull-right">
					<a href="<?php echo site_url('linegym/admin/logout');?>">
	...
	jQuery(document).ready(function($)
	{
		...
		setTimeout(function()
		{
			...
			toastr.success("Hola y bienvenido <?php echo $this->session->NAME_PERSON ?>", "Bienvenido", opts);
		}, 3000);
